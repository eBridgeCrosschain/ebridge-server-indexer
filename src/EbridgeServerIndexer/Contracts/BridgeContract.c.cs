...
namespace EBridge.Contracts.Bridge {
  ...
  public partial class ApproveTransfer : aelf::IEvent<ApproveTransfer>
  {
    public global::System.Collections.Generic.IEnumerable<ApproveTransfer> GetIndexed()
    {
      return new List<ApproveTransfer>
      {
      };
    }

    public ApproveTransfer GetNonIndexed()
    {
      return new ApproveTransfer
      {
        Sender = Sender,
        ReceiptId = ReceiptId,
      };
