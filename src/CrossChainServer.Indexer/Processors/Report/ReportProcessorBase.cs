    ...
    where TEvent : IEvent<TEvent>, new()
{
    ...
    protected string GetReportInfoId(string chainId, long roundId, string token, string targetChainId)
    {
        return IdGenerateHelper.GetId(chainId, roundId, token, targetChainId);
    }
}